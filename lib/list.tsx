...
export const locationList = [
  ...
  },
  {
    ...
    desc: "Buy and sell quality used furniture and electronics in Dubai.",
    link: "#",
  },
  {
  ...
  },
  {
    ...
    desc: "Reliable used furniture and home items available in Ras Al Khaimah.",
    link: "#",
  },
  {
...
export const ufdFaqs = [
  {
    question: "How do I sell my used furniture in Dubai?",
    answer: (
      <>
        <p>
          Selling your used furniture through Rukun Al Arooba is
          straightforward. Contact us via WhatsApp, phone, or our website and
          describe the items you want to sell (photos help speed things up).
        </p>
        <p>
          We’ll provide a preliminary price estimate and schedule a convenient
          time for an on-site assessment. Our expert evaluator will visit your
          location, perform a detailed inspection, and present a final offer.
        </p>
        <p>
  ...
  {
    question: "What types of furniture do you buy?",
    answer: (
      <>
        <p>
          We buy virtually all types of household and office furniture. Our
        ...
        <ul>
          ...
          <li>Dining room pieces (tables, chairs, buffets, china cabinets)</li>
          <li>Kitchen cabinets and modular kitchen setups</li>
          <li>
            Office furniture (desks, ergonomic chairs, conference tables,
            workstations, filing cabinets)
          </li>
          <li>
            Outdoor & patio furniture (patio sets, garden furniture, poolside
            seating)
          </li>
          <li>
        ...
        <p>
          Our comprehensive categories reflect broad market knowledge and
          storage capacity, so feel free to list single items or full-house
          clearances.
        </p>
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        <p>
          Initial response time is typically 5–10 minutes for first contact. We
          can usually schedule assessment appointments for the same day or the
          next day depending on availability.
        </p>
        <p>
          Pickup is often arranged immediately after assessment and agreement on
          pricing. For urgent cases we can accommodate same-day furniture
  ...
  },
  {
    ...
    answer: (
      <>
        <p>
          Yes — we evaluate furniture regardless of condition. Many items that
          appear damaged can be refurbished or repurposed, and may still hold
          considerable value.
        </p>
        <p>
          Our refurbishment partners and in-house expertise allow us to
          determine realistic restoration costs and offer fair prices based on
  ...
  },
  {
    ...
    answer: (
      <>
        <p>
          We offer multiple payment options to suit different customer
          preferences and transaction sizes. These include immediate cash
          payments, bank transfers, and bank checks.
        </p>
        <p>
          If you have a preferred payment method, let us know during the
          assessment and we’ll accommodate it where possible.
        </p>
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        <p>
          Yes. Through our partnership with Abu Muhammad Movers, we provide
          professional pickup and removal services at competitive rates.
        </p>
        <p>
          Our team handles packing, loading and transport with care to protect
          your property and remaining possessions during the process.
        </p>
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        <p>
          Pricing is based on several transparent factors: the original value,
          current condition, brand reputation, local market demand, and the
          furniture&lsquo;s restoration potential.
        </p>
        <p>
          During assessment we explain how each factor affects the offer so you
          understand the valuation and feel confident in the price.
        </p>
      </>
    ),
  },
  {
    question: "Can I sell just one piece of furniture?",
    answer: (
      <>
        <p>
          Absolutely. We purchase single items as readily as whole sets or
          full-house and office clearances. Whether it’s one chair or an entire
          property, you’ll receive the same professional service and fair
          pricing.
        </p>
      </>
    ),
