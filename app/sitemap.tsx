...
const pages: MetadataRoute.Sitemap = [
  ...
  // Services
  {
    ...
    priority: 0.7,
    images: ["/service/used-refrigerators-in-uae.jpg"],
    lastModified: "2026-08-19",
  },
  {
    url: "/used-ac-buyers-in-dubai",
    changeFrequency: "monthly",
    priority: 0.7,
    images: ["/service/used-ac-buyers-in-dubai.jpg"],
    lastModified: "2026-08-19",
  },
  {
  ...
  {
    url: `/${decodeURIComponent("مشترو-المكيفات-المستعملة")}`,
    changeFrequency: "monthly",
    priority: 0.9,
    images: ["/service/مشترو-المكيفات-المستعملة-في-دبي.jpg"],
    lastModified: "2026-08-19",
  },
];
