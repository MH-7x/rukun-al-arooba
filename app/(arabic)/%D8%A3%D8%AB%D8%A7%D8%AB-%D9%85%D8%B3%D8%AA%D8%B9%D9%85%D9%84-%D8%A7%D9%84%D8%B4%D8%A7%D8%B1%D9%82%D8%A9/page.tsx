      ...
      <div className="container mx-auto max-w-7xl px-3 py-18 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
            <div>
              ...
              <p className="mb-6 text-lg leading-relaxed text">
                البحث عن اثاث مستعمل الشارقة بجودة عالية وسعر مناسب؟ ركن العروبة
                هو الحل الأمثل. نحن شركة مرخصة رسمياً منذ 2018، ولدينا معرض
                حقيقي يمكنك زيارته في شارع الاستقلال ببوشغارة، حي القاسمية.
                خبرتنا في تجارة الأثاث تتجاوز 20 عاماً، مما يعني أننا نفهم
                تماماً ما تحتاجه.
              </p>
              <p className="mb-6 text-base leading-relaxed text">
                نقدم خدمات شاملة في بيع وشراء اثاث مستعمل بجميع أنواعه. سواء كنت
                تريد بيع أثاثك القديم بسرعة، أو تبحث عن قطع أثاث مستعملة بحالة
                ممتازة، نحن هنا لمساعدتك. نستجيب لطلبك خلال 5-10 دقائق عبر
                واتساب أو الهاتف، ونقدم تقييماً فورياً وعادلاً.
              </p>
        ...
        <section id="why-us" className="mb-12 mt-36">
          ...
          <p className="mb-10 text-center text-lg text">
            عندما تتعامل مع شراء أو بيع الأثاث المستعمل، تحتاج إلى شركة موثوقة.
            الفرق بيننا وبين الآخرين واضح.
          </p>
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="rounded-lg bg-white p-6 shadow-md transition-shadow hover:shadow-lg">
              ...
              <p className="text">
                نرد على استفساراتك خلال 5-10 دقائق. أرسل الصور عبر واتساب لتقييم
                أولي سريع. عملية البيع والشراء بسيطة، واضحة، وتتم في نفس اليوم.
              </p>
            </div>
            {/* Feature 3 */}
            <div className="rounded-lg bg-white p-6 shadow-md transition-shadow hover:shadow-lg">
            ...
            <div className="rounded-lg bg-white p-6 shadow-md transition-shadow hover:shadow-lg">
              ...
              <p className="text">
                ...
                للتوصيل في جميع أنحاء الشارقة والإمارات. النقل آمن وسريع وعناية
                فائقة.
              </p>
            </div>
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
            ...
            <div className="rounded-lg bg-[#a06844] p-6 text-center">
              ...
              <p className="text-white/90">
                خلال 5-10 دقائق، سنعطيك تقييماً أولياً عادلاً ومنافساً. قد نزورك
                لفحص نهائي لضمان الدقة.
              </p>
            </div>
            {/* Step 3 */}
            <div className="rounded-lg bg-[#a06844] p-6 text-center">
        ...
        <section id="how-to-buy" className="mb-12 mt-36">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
            ...
            <div className="rounded-lg bg-white p-8 shadow-lg">
              ...
              <p className="mb-4 text">
                لا تستطيع زيارة المعرض؟ لا مشكلة. تصفح موقعنا أو تواصل معنا عبر
                واتساب. سنرسل لك صوراً تفصيلية للقطع التي تهمك.
              </p>
              <p className="text">
        ...
        <section id="categories" className="mb-12 mt-36">
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="rounded-lg bg-white p-6 shadow-md">
              ...
              <p className="text">
                أسرّة، خزائن ودواليب، طاولات تسريح، وطاولات جانبية. كل القطع تم
                فحصها وتنظيفها جيداً.
              </p>
            </div>
            {/* Category 2 */}
            <div className="rounded-lg bg-white p-6 shadow-md">
              ...
              <p className="text">
                أطقم كنب (جلد وقماش)، طاولات قهوة، مكتبات، وأرفف. علامات تجارية
                معروفة وجودة عالية.
              </p>
            </div>
            {/* Category 3 */}
            ...
            <div className="rounded-lg bg-white p-6 shadow-md">
              ...
              <p className="text">
                مكاتب تنفيذية، كراسي مريحة، خزائن ملفات، طاولات اجتماعات، ومكاتب
                استقبال.
              </p>
            </div>
            {/* Category 5 */}
            ...
            <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
              <div>
                ...
                <ul className="list-inside list-disc space-y-2 text">
                  ...
                  <li>
                    <strong>عمر القطعة:</strong> الأحدث أغلى، لكن القطع القديمة
                    الأنيقة لها قيمتها.
                  </li>
                  <li>
              ...
              <div>
                ...
                <p className="mt-4 text">
                  ...
                  الشفافية تجعلنا موثوقين في بيع اثاث مستعمل الشارقة بأفضل سعر.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
            ...
            <div className="rounded-lg bg-white p-8 shadow-lg">
              ...
              <ul className="mb-4 list-inside list-disc space-y-2 text">
                <li>
                  <strong>نظفه جيداً:</strong> الأثاث النظيف يحصل على سعر أعلى.
                </li>
                <li>
              ...
              <h4 className="mb-2 text-lg font-semibold blue">ما يجب تجنبه:</h4>
              <ul className="list-inside list-disc space-y-2 text">
                <li>
            ...
            <div className="rounded-lg bg-white p-8 shadow-lg">
              ...
              <ul className="mb-4 list-inside list-disc space-y-2 text">
                ...
                <li>
                  <strong>تحقق من نظافة الأقمشة:</strong> ابحث عن بقع أو روائح.
                </li>
                <li>
              ...
              <ul className="mb-4 list-inside list-disc space-y-2 text">
                <li>
                  عمر القطعة، سبب البيع، تاريخ الصيانة، وهل يوجد ضمان؟ (نحن نجيب
                  بصراحة).
                </li>
              </ul>
              <h4 className="mb-2 text-lg font-semibold blue">
        ...
        >
          ...
          <div className="grid grid-cols-1 gap-4 text-left sm:grid-cols-2 md:grid-cols-4">
            ...
            <div className="rounded-md bg-white p-4 shadow-sm">
              <h3 className="font-semibold text-green-700">الاقتصاد الدائري</h3>
              <p className="text-sm text">
          ...
          <p className="mt-6 text-lg font-medium headline">
            توفير المال وحماية البيئة معاً - الأثاث المستعمل يوفر لك حتى 70% من
            سعر الجديد.
          </p>
        </section>
        ...
        <section id="other-emirates" className="mb-12 mt-36">
          ...
          <p className="mb-6 text-center text-lg text">
            خدماتنا لا تقتصر على الشارقة فقط. نوفر توصيل سريع وآمن بفضل شراكتنا
            مع أبو محمد للنقل إلى:
          </p>
          <div className="flex flex-wrap justify-center gap-3">
            {["دبي", "عجمان", "أبوظبي (خاصة مصفح)", "العين", "رأس الخيمة"].map(
              (city) => (
                <span
                  key={city}
        ...
        <section id="faq" className="mb-12 mt-36">
          ...
          <div className="space-y-4 mt-16 max-w-4xl mx-auto">
            {[
              {
                q: "س1: كم يستغرق تقييم أثاثي؟",
                a: "ج: نقدم تقييم أولي خلال 5-10 دقائق عبر واتساب. إذا احتجنا لتقييم نهائي، نزور موقعك ونفحص الأثاث مباشرة.",
              },
              {
                q: "س2: هل تشترون الأثاث التالف؟",
                a: "ج: نعم، نشتري الأثاث التالف بشكل بسيط. لدينا فريق صيانة لإصلاحه. الأضرار الكبيرة قد تؤثر على السعر.",
              },
              {
                q: "س3: هل توفرون خدمة التوصيل؟",
                a: "ج: نعم، لدينا شراكة مع أبو محمد لنقل الأثاث. نوفر خدمة توصيل بأسعار تفضيلية لجميع مناطق الإمارات.",
              },
              {
                q: "س4: ما هي طرق الدفع المتاحة؟",
                a: "ج: نوفر طرق دفع متعددة: نقدي، تحويل بنكي، وشيكات بنكية. اختر ما يناسبك.",
              },
              {
                q: "س5: هل يوجد ضمان على الأثاث المباع؟",
                a: "ج: نعم، نوفر ضمان على منتجاتنا. لدينا أيضاً سياسة إرجاع واضحة إذا لم يلبي الأثاث توقعاتك.",
              },
              {
                q: "س6: أين يقع معرضكم؟",
                a: 'ج: معرضنا في شارع الاستقلال، بوشغارة، حي القاسمية، الشارقة. ابحث عنا على خرائط جوجل باسم "ركن العروبة للأثاث المستعمل".',
              },
              {
                q: "س7: كيف تحددون أسعار الشراء؟",
                a: "ج: نحدد الأسعار بناءً على حالة الأثاث، العلامة التجارية، العمر، والطلب في السوق. نضمن عروض عادلة ومنافسة.",
              },
              {
                q: "س8: هل تشترون من الفلل والشقق؟",
                a: "ج: نعم، نشتري من الفلل، الشقق، المكاتب، والفنادق. سواء قطعة واحدة أو محتويات كاملة.",
              },
              {
                q: "س9: هل يمكنني رؤية الأثاث قبل الشراء؟",
                a: "ج: بالتأكيد! ندعوك لزيارة معرضنا. أو يمكننا إرسال صور تفصيلية عبر واتساب.",
              },
              {
                q: "س10: كم تستغرق عملية الشراء/البيع؟",
                a: "ج: بعد الاتفاق على السعر، نتم العملية فوراً. الدفع والاستلام في نفس اليوم.",
              },
            ].map((item, index) => (
              <div
                key={index}
              ...
              >
                <details className="group p-4">
                  ...
                  <p className="mt-3 text">{item.a}</p>
                </details>
              </div>
            ))}
          </div>
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
            ...
            <div className="rounded-lg bg-white p-6 shadow-md">
              <p className="mb-4 italic text">
                ...
                سريعة جداً. استلموا الأثاث في نفس اليوم ودفعوا نقداً. أنصح بهم.
              </p>
        ...
        >
          <div className="text-center">
            ...
            <div className="mb-8 space-y-2 text-lg text-white/90">
              <p>
                <strong>العنوان:</strong> شارع الاستقلال، بوشغارة، حي القاسمية،
                الشارقة
              </p>
              <p>
