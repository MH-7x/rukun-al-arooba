...
const FaqsSchema = generateFAQSchema(convertFaqsForSchema(SharjahBuyersFaqs));
    ...
    <>
      ...
      <main className="overflow-hidden">
        <Breadcrumb
          items={[
            { label: "Home", href: "/" },
            { label: "Used Furniture Buyers in Sharjah" },
          ]}
        />
        <section className="grid-wrapper w-full flex items-center justify-center flex-col py-16 md:px-0 px-3">
          ...
          <div className="max-w-3xl mx-auto text-center text mt-5">
            <p>
              ...
              Arooba has been the trusted choice for thousands of residents
              since 2018, offering the best prices for your pre-owned furniture
              with instant valuation and same-day pickup.
            </p>
          </div>
        ...
        <section className="w-full grid md:grid-cols-2 grid-cols-1 items-center mt-20 gap-16">
          <div className="text md:pl-16 md:text-lg flex flex-col gap-y-3 md:px-0 px-3">
            <p>
              As a government-registered furniture buyer with a physical
              showroom on Al Estiqlal Street, Bu Shaghara, we&apos;ve built our
              reputation on transparency, fair pricing, and exceptional service
              over 20+ years in Sharjah&apos;s furniture market.
            </p>
            <p>
              Our team responds within minutes (5–10) on phone/WhatsApp and
              offers free same-day pickup via our moving partner.
            </p>
            <p>
        ...
        <section className="md:px-0 px-3 mt-36 max-w-3xl mx-auto ">
          ...
          <div className="flex">
            ...
            <div className="pt-1 pb-8">
              ...
              <p className="text">
                Accept the offer and choose a convenient pickup time (same-day
                or next available). Our trained movers handle disassembly and
                loading.
              </p>
              <i className="text">
        ...
        >
          ...
          <p className="mt-3 text max-w-3xl mx-auto text-center">
            Sharjah sellers have plenty of options, but Rukun Al Arooba stands
            out for proven reliability and convenience:
          </p>
          ...
          <div className="mt-16 grid md:grid-cols-3 grid-cols-1 gap-10">
            <div>
              ...
              <p className="text-sm text mt-2 pb-3 border-b-2 border-[#c07d53a5]">
                ...
                signals like ours are rare among online buyers, and they make
                all the difference in your safety and confidence.
              </p>
            </div>
            <div>
              <h3 className="text-xl font-medium headline flex items-center gap-x-2">
                <CheckCircle size={25} className="pri" /> Proven Track Record
                (20+ years)
              </h3>
              <p className="text-sm text mt-2 pb-3 border-b-2 border-[#c07d53a5]">
            ...
            <div>
              ...
              <p className="text-sm text mt-2 pb-3 border-b-2 border-[#c07d53a5]">
                ...
                view some items for sale. A local shop means we’re accountable
                and accessible.
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-sm text mt-2 pb-3 border-b-2 border-[#c07d53a5]">
                ...
                packers/movers) to offer free collection of your items. You
                don’t have to lift a finger. Our movers will even carefully
                transport your furniture to our facility if needed.
              </p>
            </div>
            <div>
              <h3 className="text-xl font-medium headline flex items-center gap-x-2">
              ...
              <p className="text-sm text mt-2 pb-3 border-b-2 border-[#c07d53a5]">
                Cash on delivery, instant bank transfer, or even post-dated
                checks – you choose the payment method that works for you. No
                gimmicks or hidden fees, just straight cash.
              </p>
            </div>
            <div>
              <h3 className="text-xl font-medium headline flex items-center gap-x-2">
              ...
              <p className="text-sm text mt-2 pb-3 border-b-2 border-[#c07d53a5]">
                ...
                something needs a quick repair or polish, our craftsmen handle
                it. We ensure nothing leaves our facility broken or unsellable –
                and you get paid for a guaranteed quality item.
              </p>
            </div>
          </div>
          <div className="mt-16 flex flex-col gap-y-2 text max-w-4xl mx-auto text-center">
            ...
            <p>
              And because recycling furniture is beneficial, you can rest
              assured this sale is good for Sharjah too. As one review notes
              about selling second-hand goods: you “reduce landfill waste” and
              even help the local economy .{" "}
            </p>
            <p>
              In short, selling with Rukun Al Arooba is safe, smart, and
        ...
        >
          <div>
            ...
            <p className="mt-3 text">
              As the leading used furniture buyers near you, we serve all areas
              of Sharjah including Al Nahda, Al Qasimiya, Al Majaz, Al Taawun,
              Al Khan, Muwaileh, and Al Ramtha.
            </p>
            <ul className="mt-5 list-disc list-inside text">
              ...
              <li className="mt-2">
                Residential neighborhoods from Al Mareija to Al Rahmaniya
                receive our full attention with scheduled pickups that respect
        ...
        <section className="md:px-0 px-3 mt-36 max-w-4xl mx-auto border-b-4 pb-5">
          ...
          <p className="mt-5 text">
            <b>Why it matters:</b> Presentation is crucial, even for used goods.
            A clean item appears well-maintained and can significantly increase
            its perceived value.{" "}
          </p>{" "}
          <ul className="mt-5 list-disc ml-5 text">
            {" "}
            <li>
              <b>Action:</b> Wipe down surfaces, vacuum upholstery, and polish
              any wood or metal.
            </li>{" "}
          </ul>{" "}
          <h3 className="font-medium text-xl text mt-7">
          ...
          <ul className="mt-5 list-disc ml-5 text">
            {" "}
            <li>
              <b>Action:</b> Photograph your furniture in a well-lit area.
              Capture it from multiple angles (front, back, sides) and take
              close-up shots of any specific details, including signs of wear or
              damage.
            </li>{" "}
          </ul>{" "}
          <h3 className="font-medium text-xl text mt-7">
          ...
          <p className="mt-5 text">
            <b>Why it matters:</b> Complete sets, such as a full bedroom or
            dining set, are more desirable and typically command premium rates
            compared to selling the same items individually.{" "}
          </p>{" "}
          <ul className="mt-5 list-disc ml-5 text">
            {" "}
            <li>
          ...
          <ul className="mt-5 list-disc ml-5 text">
            ...
            <li>
              ...
              of value. Be aware that genuine antiques and authenticated
              designer pieces will receive premium pricing from us.
            </li>{" "}
          </ul>{" "}
          <h3 className="font-medium text-xl text mt-7">
          ...
          <p className="mt-5 text">
            <b>Why it matters:</b> Selling during peak demand can sometimes
            yield better offers.{" "}
          </p>{" "}
          <ul className="mt-5 list-disc ml-5 text">
            {" "}
          ...
          desc={
            <>
              <p>
                ...
                complicate your move. Rukun Al Arooba makes selling simple,
                fast, and profitable.{" "}
              </p>
              <p>
                With our government license, physical showroom, 20+ years of
                experience, and commitment to fair pricing, we&apos;re the
                trusted choice for thousands of satisfied customers across
                Sharjah and the UAE.
              </p>
            </>
          }
