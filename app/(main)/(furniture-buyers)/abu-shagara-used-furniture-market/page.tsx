      ...
      <main className="overflow-hidden">
        <section className="grid-wrapper w-full flex items-center justify-center flex-col py-16 md:px-0 px-3">
          ...
          <div className="max-w-3xl mx-auto text-center text mt-5">
            <p>
              Welcome to Abu Shagara used furniture market in Sharjah. For over
              20 years, Rukun Al Arooba Used Furniture has been helping
              customers find quality pre-owned furniture they can trust.
            </p>
            <p className="mt-1">
        ...
        <section className="mt-36 md:w-11/12 mx-auto grid md:grid-cols-2 grid-cols-1 gap-10 items-center md:ml-32 overflow-hidden md:px-0 px-3">
          <div>
            ...
            <p className="mt-1 text">
              At the Abu Shagara used furniture market, you often find prices
              that are 50-70% lower than retail stores, but the quality remains
              high.
            </p>
        ...
        <section className="md:px-0 px-3 mt-36 max-w-4xl mx-auto border-b-4 pb-5">
          ...
          <p className="mt-3 text">
            ...
            items in person; our expert team inspects, repairs, and polishes
            every piece before it goes on display. When you buy from us, you
            get:
          </p>
              ...
              {[
                {
                  ...
                  description: (
                    <>
                      ...
                      <p>
                        Our fair pricing policy has earned us a reputation as
                        the most trusted buyer in the area.
                      </p>
                    </>
                  ),
                },
                {
                  ...
                  description: (
                    <>
                      <p>
                        When purchasing from our Abu Shagara used furniture
                        market store, you benefit from multiple advantages that
                        set us apart.
                      </p>
                      <p>
                      ...
                      <p>
                        Our easy return policy ensures your complete
                        satisfaction; if any piece doesn&apos;t meet your
                        expectations, we&apos;ll gladly accept returns,
                        demonstrating our confidence in our quality standards.
                      </p>
                    </>
                  ),
                },
        ...
        <CTA
          ...
          desc={
            <>
              <p>
                Experience the difference of shopping with a trusted,
                established company in the Abu Shagara used furniture market.
              </p>
              <p>
                Our showroom on Al Estiqlal Street is open six days a week,
                ready to serve you with the finest selection of quality used
