...
const FaqsSchema = generateFAQSchema(convertFaqsForSchema(BedsBuyersFaqs));
      ...
      <main className="overflow-hidden">
        <section className="grid-wrapper w-full flex items-center justify-center flex-col py-16 md:px-0 px-3">
          ...
          <div className="max-w-3xl mx-auto text-center text mt-5">
            ...
            <p className="mt-1">
              Whether you are moving, upgrading your furniture, or simply want
              to free up space, we make selling your bed simple, transparent,
              and rewarding.
            </p>
          </div>
              ...
              <li className="grid grid-cols-5 md:gap-x-0 gap-x-3border-b-2 border-[#c07d53] pb-5">
                ...
                <div className="col-span-4 md:pl-0 pl-4">
                  ...
                  <p className="mt-2 text-sm text">
                    ...
                    details about your item’s condition and your location in
                    Dubai or anywhere in the UAE.
                  </p>
                </div>
              </li>
              <li className="grid grid-cols-5 md:gap-x-0 gap-x-3border-b-2 border-[#c07d53] pb-5">
                ...
                <div className="col-span-4 md:pl-0 pl-4">
                  ...
                  <p className="mt-2 text-sm text">
                    We’ll visit you soon to quickly check your bed. We explain
                    our price clearly. This hands-on assessment considers
        ...
        >
          ...
          <p className="mt-3 text max-w-3xl mx-auto text-center">
            ...
            frustrating—delayed responses, endless haggling, and time-wasters.
            At Rukun Al Arooba, we provide a direct, professional
            alternative.Here’s why hundreds of sellers in Dubai trust us:
          </p>
          ...
          <div className="mt-16 grid md:grid-cols-2 grid-cols-1 gap-10 max-w-3xl mx-auto  ">
            ...
            <div>
              ...
              <p className="text-sm text mt-2 pb-3 border-b-2 border-[#c07d53a5]">
                Once you agree, we handle same-day or next-day pickup anywhere
                in Dubai.
              </p>
            </div>
            <div>
