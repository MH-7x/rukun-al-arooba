...
import { applianceFaqs } from "@/lib/list";
...
const FaqsSchema = generateFAQSchema(convertFaqsForSchema(applianceFaqs));
const page = () => {
  return (
    <>
      {" "}
      ...
      <main className="service-page">
          ...
          <article className="md:col-span-2 col-span-1 md:order-2 order-1 service-article">
            <section className="section why-choose">
              ...
              <p className="lead">
                ...
                experience. We provide a fast, transparent service for sellers
                and reliable refurbished appliances for buyers.
              </p>
              ...
              <ul className="feature-list">
                ...
                <li>
                  Short warranty and straightforward returns on refurbished
            ...
            <section className="section types">
              ...
              <p>
                ...
                <strong>used home appliances Dubai</strong> residents trust —
                from large white goods to small kitchen gadgets. Below is a
                detailed breakdown of each appliance category, the checks we
                perform when buying, what we offer when selling.
              </p>
              ...
              <div className="appliance-card" id="refrigerators">
                ...
                <p>
                  ...
                  French-door models. Each unit is tested for cooling
                  performance, compressor health, thermostat accuracy, door
                  seals, and internal odors. We also check for significant
                  dents, rust, and water-leak issues.
                </p>
                ...
                <ul className="checklist">
                  ...
                  <li>
                    Compressor and refrigerant status (no strange noises).
                  </li>
              ...
              <div className="appliance-card" id="washing-machines">
                ...
                <p>
                  ...
                  Inspections focus on motor health, spin balance, drum
                  integrity, water inlet and drainage, and electronic controls.
                </p>
                ...
                <p className="alt">
                  <em>
                    used washing machines dubai - cleaned front load washer
                  </em>
                </p>
              </div>
              ...
              <div className="appliance-card" id="dryers">
                ...
                <p>
                  ...
                  function, drum rotation, venting condition, and safety
                  switches. Lint-flap and venting are cleaned and tested to
            ...
            <section className="section pricing">
              <h2 className="section-title">
                How We Price & What Affects Value
              </h2>
              <p>
                Price depends on brand, model, age, working condition, cosmetic
                state, and availability of spare parts. Popular,
                energy-efficient models fetch higher resale value. We provide
                honest, transparent offers after a photo appraisal or in-person
                inspection.
              </p>
            ...
            <section className="section guarantee">
              ...
              <p>
                Every refurbished appliance includes a short warranty and a
                clear return policy so customers across Dubai can purchase with
                peace of mind.
              </p>
            </section>
            <div className="my-10 grid md:grid-cols-2 w-full grid-cols-1 gap-5 relative bg-gray-200 rounded-2xl overflow-hidden">
            ...
            <section className="section buy-confidence">
              ...
              <p>
                ...
                delivery across Dubai through trusted movers for safe,
                affordable transport of bulky items.
              </p>
            </section>
        ...
        <CTA
          ...
          desc={
            <>
              <p>
                Ready to buy or sell quality used home appliances Dubai? Contact
                Rukun Al Arooba today for a free quote, quick pickup, and
