...
const FaqsSchema = generateFAQSchema(convertFaqsForSchema(electronicsFaqs));
          ...
          <article className="md:col-span-2 col-span-1 md:order-2 order-1 service-article">
            <section className="section why-sell" id="why-sell">
              ...
              <ul className="feature-list">
                <li>
                  ...
                  WhatsApp or the website and get a transparent, competitive
                ...
                <li>
                  <strong>Multiple payment choices:</strong> Cash on pickup,
                  bank transfer, or cheque — choose what suits you.
                </li>
                <li>
            ...
            <section className="section what-we-buy" id="what-we-buy">
              ...
              <ul className="checklist">
                <li>
                  Mobile phones &amp; tablets (all brands &amp; conditions)
                </li>
              ...
              <p className="note">
                If you’re unsure, send clear photos, model/brand and the
                location and we’ll advise right away.
              </p>
            </section>
            ...
            <section className="section process" id="how-selling-works">
              ...
              <ol className="steps">
                ...
                <li>
                  <strong>Get an instant quote:</strong> We evaluate and return
                  a fair offer (use keywords like{" "}
                  <span className="keyword">
                    sell used electronics in Dubai
                  </span>{" "}
                  in your message).
                </li>
                <li>
            ...
            <section className="section valuations" id="valuations">
              ...
              <p>
                We value items based on brand, model, age, working condition,
                and market demand. To get the best price, share: brand, model
                number, photos of serial/condition, and whether accessories/box
                are included.
              </p>
            </section>
            ...
            <section className="section service-areas" id="service-areas">
              ...
              <p>
                Below are the emirates and areas we serve — each entry
                highlights what we offer locally so sellers know exactly what to
                expect.
              </p>
              <div className="my-5 flex gap-x-3">
              ...
              <p>
                We buy mobile phones, laptops, smart TVs, gaming consoles and
                home appliances across Dubai — from Deira and Bur Dubai to
                Jumeirah, Al Quoz, JLT and Dubai Marina.
              </p>
              <h3 className="font-bold my-5 text-lg headline underline underline-offset-2">
                Abu Dhabi (sell used electronics in Abu Dhabi)
              </h3>
              <p>
                Selling electronics in Abu Dhabi? We collect from residential
                and commercial addresses across the city. Whether you’re selling
                office IT equipment, refrigerators or smartphones, we provide
                fair offers, secure data wiping and fast bank transfer or cash
                payment on pickup.
              </p>
              <h3 className="font-bold my-5 text-lg headline underline underline-offset-2">
              ...
              <p>
                ...
                Hay Al Qasimiah, Bu Shaghara and surrounding neighborhoods. If
                you search for used electronics buyers near me Sharjah, message
                us — we reply within minutes and can arrange quick collection.
              </p>
              <h3 className="font-bold my-5 text-lg headline underline underline-offset-2">
                Ajman, Ras Al Khaimah & Al Ain (regional coverage)
              </h3>
              <p>
                We regularly buy electronics from Ajman, Ras Al Khaimah and Al
                Ain — including bulky appliances like washing machines and AC
                units. For these emirates we offer scheduled pickup windows and
