    ...
    <main className="overflow-hidden">
        ...
        <div className="mx-auto max-w-4xl pt-20">
          ...
          <div className="text-center">
            ...
            <p className="mt-3 text">
              ...
              way people buy and sell pre-owned furniture across the United Arab
              Emirates.
            </p>
      ...
      >
        ...
        <div className="col-span-2 py-10 md:border-t-0 md:text-lg md:border-l-2 border-t-2 border-[#c07d53] md:pl-10 text">
          <p>
            ...
            us unparalleled expertise in understanding what our customers need –
            whether you&lsquo;re furnishing your first home, upgrading your
            office, or looking to sell furniture during a transition.
          </p>
          <p>
            {" "}
            We&lsquo;ve built our reputation on trust, quality, and exceptional
            service that sets us apart in the UAE&lsquo;s competitive used
            furniture market.
          </p>
        </div>
      </section>
      ...
      >
        ...
        <div className="col-span-2 py-10 md:text-lg md:border-t-0 md:border-l-2 border-t-2 border-[#c07d53] md:pl-10 text">
          <p>
            ...
            is simple: help you save money without compromising on style or
            quality.
          </p>
          <p>
            {" "}
        ...
        <div className="mt-16 grid md:grid-cols-3 grid-cols-1 gap-10">
          <div>
            <h3 className="text-xl font-medium headline flex items-center gap-x-2">
              <CheckCircle size={25} className="pri" /> Legitimacy You Can Trust
            </h3>
            <p className="text-sm text mt-2 pb-3 border-b-2 border-[#c07d53a5]">
              Unlike many freelance operators in the market, we are an
              officially registered company with the UAE government since 2018.
              Our physical showroom in Sharjah serves as your guarantee of
              authenticity – you can visit, inspect, and experience our
              furniture firsthand.
            </p>
          </div>
          <div>
            ...
            <p className="text-sm text mt-2 pb-3 border-b-2 border-[#c07d53a5]">
              Time is precious. When you contact us via WhatsApp or our website,
              expect a response within 5-10 minutes. Whether you&lsquo;re buying
              or selling, we value your time and make the process seamless and
              efficient.
            </p>
          </div>
          <div>
            ...
            <p className="text-sm text mt-2 pb-3 border-b-2 border-[#c07d53a5]">
              We don&lsquo;t just resell furniture – we restore it. Every piece
              undergoes thorough inspection, necessary repairs, and professional
              polishing before reaching our showroom. When you buy from us,
              you&lsquo;re getting furniture that looks and feels like new,
              backed by our quality guarantee.
            </p>
          </div>
          <div>
            <h3 className="text-xl font-medium headline flex items-center gap-x-2">
              <CheckCircle size={25} className="pri" /> Flexible Payment Options
            </h3>
            <p className="text-sm text mt-2 pb-3 border-b-2 border-[#c07d53a5]">
              Your convenience matters. We accept multiple payment methods
              including cash, online deposits, and bank checks – giving you the
          ...
          <div>
            ...
            <p className="text-sm text mt-2 pb-3 border-b-2 border-[#c07d53a5]">
              ...
              everything from showroom to your doorstep with care and precision
            </p>
          </div>
          <div>
            <h3 className="text-xl font-medium headline flex items-center gap-x-2">
              <CheckCircle size={25} className="pri" /> Customer-First Warranty
            </h3>
            <p className="text-sm text mt-2 pb-3 border-b-2 border-[#c07d53a5]">
      ...
      >
        <div>
          ...
          <p className="mt-3 text">
            While our showroom graces Al Estiqlal Street in Bu Shaghara, Hay Al
            Qasimiah, Sharjah, our services extend across the entire UAE:
          </p>
      ...
      <section className="relative py-20 px-6 mt-20">
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text text-lg">
            ...
            UAE. Every purchase from Rukun Al Arooba is a step towards a greener
            future.
          </p>
        </div>
      </section>
      ...
      <div className="pri-bg text-gray-100 text-center py-6 px-6">
        <p>
          Moving, upgrading, downsizing, or furnishing on a budget — we make it
