        ...
        <article className="md:col-span-2 col-span-1 md:order-2 order-1 service-article">
          ...
          >
            ...
            <p>
              ...
              liquidations. If you have quality furniture, we are interested in
              buying it.
            </p>

            <ul className="checklist">
              <li>
                <strong>Office Desks and Workstations:</strong> executive desks,
                L-shaped desks, computer tables, height-adjustable standing
                desks, cubicle systems, and modular workstations.
              </li>
              <li>
              ...
              <li>
                <strong>Storage Solutions &amp; Cabinets:</strong> vertical and
                lateral filing cabinets, mobile pedestals, cupboards,
              ...
              <li>
                ...
                refrigerators, monitors, and other essential office appliances.
              </li>
            </ul>
          </section>
          ...
          <section className="section why-choose-office" id="why-choose-office">
            <h2 className="section-title">
              Why Choose Rukun Al Arooba to Sell Your Office Furniture in Dubai?
            </h2>
            <p>
              In a crowded market, choosing the right buyer is crucial. You need
              a partner who is reliable, fast, and offers fair value. Rukun Al
              Arooba is not just another buyer; we are a professional,
              customer-centric company dedicated to providing an unparalleled
              selling experience. Here’s what sets us apart.
            </p>
            ...
            <div className="appliance-card">
              ...
              <p>
                ...
                Simply contact us on WhatsApp with photos of your items, and our
                experts will provide a free, transparent quote within{" "}
                <strong>5–10 minutes</strong>. We offer top cash for used office
                furniture in Dubai, ensuring you get the best return on your
                assets.
              </p>
            </div>
            ...
            <div className="appliance-card">
              ...
              <p>
                Peace of mind is priceless. Unlike many freelance operators and
                anonymous websites, Rukun Al Arooba is an officially registered
                company with the UAE government, established in 2018. With over
                20 years of experience in the furniture trading industry and a
                physical store on Al Estiqlal Street in Sharjah, you can be
                confident you are dealing with a credible and reliable business.
              </p>
            </div>
            ...
            <div className="appliance-card">
              ...
              <p>
                Worried about the logistics of moving bulky furniture? We’ve got
                it covered. Through our exclusive partnership with{" "}
                <strong>Abu Muhammad Movers</strong>, we provide a seamless,
                professional, and discounted pickup service from your location.
                We handle all the heavy lifting, ensuring a smooth and efficient
                office furniture disposal process, whether you&lsquo;re in
                Dubai, Sharjah, or anywhere in the UAE.
              </p>
            </div>
            ...
            <div className="appliance-card">
              ...
              <p>
                ...
                price, you choose how you want to get paid. We offer a range of
                flexible payment methods to suit your needs, including instant
                cash, a secure online bank deposit, or an official company
                check.
              </p>
            </div>
          </section>
          ...
          <section className="section process-office" id="process-office">
            ...
            <ol className="steps">
              ...
              <li>
                <strong>Step 2: Receive Your Free, No-Obligation Quote</strong>{" "}
                — Our expert evaluation team will immediately review your items.
                You will receive our best cash offer directly on WhatsApp within
                just <strong>5–10 minutes</strong>.
              </li>
              <li>
                <strong>
                ...
                moving partners to schedule a pickup time that is convenient for
                you. You get paid on the spot via your chosen payment method.
                It’s that simple.
              </li>
            </ol>
          </section>
          ...
          >
            ...
            <p>
              ...
              Emirate, including Abu Dhabi, Sharjah, Ajman, Ras Al Khaimah, and
              Al Ain. No matter where your office is located, we bring our
