        ...
        <article className="md:col-span-2 col-span-1 md:order-2 order-1 service-article">
          ...
          <section className="section sofas-collection" id="sofas-collection">
            ...
            <p>
              ...
              of sofas to suit any taste and space. Each piece is hand-selected
              for its condition, durability, and design. Below is a sample of
              the types of sofas we frequently stock. For our latest arrivals,
              be sure to contact us on WhatsApp!
            </p>
            ...
            <h3 className="appliance-title">L-Shaped &amp; Sectional Sofas</h3>
            <p>
            ...
            <p>
              Maximize your space with a versatile and functional used sofa bed.
              Ideal for apartments, guest rooms, or any home needing a smart,
              space-saving solution, our sofa beds offer comfort for both
              sitting and sleeping.
            </p>

            <h3 className="appliance-title">Leather &amp; Fabric Sofa Sets</h3>
            <p>
              Whether you prefer the timeless elegance of a used leather sofa or
              the comfort and variety of a fabric set, we have you covered. Our
              collection includes durable, stylish options to match any interior
              design, from modern minimalist to classic comfort.
            </p>
            ...
            <p>
              From compact two-seaters perfect for a small apartment to spacious
              three-seaters for the family, you can find the ideal size for your
              needs. These affordable couches are perfect as standalone pieces
              or to complement your existing furniture.
            </p>
          </section>
          ...
          <section className="section sofas-difference" id="sofas-difference">
            ...
            <p>
              ...
              choosing where to buy used furniture can be stressful. We provide
              a professional, secure, and satisfying experience that sets us
              apart.
            </p>
            ...
            <h3 className="appliance-title">Our Unmatched Quality Guarantee</h3>
            <p>
              We don&apos;t just buy and flip furniture. Every used sofa we
              acquire undergoes a rigorous inspection process. If a piece
              requires any repair or polishing, our skilled team restores it to
              excellent condition before it is displayed in our showroom or
            ...
            <p>
              ...
              WhatsApp, you won’t be left waiting. We are committed to providing
              prompt and helpful responses within 5–10 minutes, ensuring a
              smooth and efficient inquiry process.
            </p>
            ...
            <p>
              ...
              about transport? We have an official partnership with Abu Muhammad
              Movers, ensuring you get a reliable and discounted delivery
              service for your <strong>used sofa for sale</strong> purchase.
            </p>
            ...
            <p>
              We stand behind the quality of our products. Every purchase comes
              with a warranty. If the furniture doesn&apos;t meet your
          ...
          >
            ...
            <p>
              ...
              trusted source for a <strong>used sofa for sale</strong> in Dubai,
              Abu Dhabi, and beyond. We regularly serve customers in:
            </p>
          ...
          <section className="section sofas-sellers" id="sofas-sellers">
            ...
            <p>
              ...
              the top <strong>used sofa buyers near me</strong>, we offer fair,
              competitive prices for your pre-owned furniture. Simply contact us
              on WhatsApp with photos of your sofa, and we’ll provide you with
              the best estimated price in minutes.
            </p>
        ...
        desc={
          <>
            <p>
              ...
              for the perfect, affordable used sofa for sale ends here. Contact
              our friendly team today and experience the Rukun Al Arooba
              difference.
            </p>
          </>
        }
