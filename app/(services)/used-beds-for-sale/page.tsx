    ...
    <main className="service-page">
      ...
      <div className="grid md:grid-cols-3 grid-cols-1 gap-10 min-h-[500px] mt-20 md:w-11/12 mx-auto">
        <article className="md:col-span-2 col-span-1 md:order-2 order-1 service-article">
          <section className="section beds-for-sale" id="used-beds">
            ...
            <p className="lead">
              Buying a <strong>used bed for sale in Sharjah</strong> should save
              you money without compromising quality. Here’s what makes us
              different:
            </p>

            <ul className="feature-list">
              <li>
                <strong>Trusted &amp; registered:</strong> Officially registered
                in 2018 and trading in Sharjah for 20+ years — real store, real
                stock.
              </li>
              <li>
                <strong>Inspected &amp; refurbished:</strong> Every bed is
                cleaned, inspected, repaired and polished so it looks and feels
                like new — we don’t sell “as-is” junk.
              </li>
              <li>
              ...
              <li>
                <strong>Multiple payment options:</strong> Cash, bank deposit or
                cheque — whatever suits you.
              </li>
              <li>
                <strong>Delivery &amp; pickup partnership:</strong> We partner
                with <strong>Abu Muhammad Movers</strong> for safe, affordable
                pickup and delivery across Dubai, Abu Dhabi, Sharjah, Ajman, Ras
                Al Khaimah and Al Ain.
              </li>
              <li>
                <strong>Warranty &amp; returns:</strong> Buy with confidence —
                we offer warranty options and a simple return policy on eligible
                items.
              </li>
              <li>
          ...
          <section className="section stock" id="beds-stock">
            ...
            <ul className="checklist">
              ...
              <li>
                <strong>Used queen &amp; double bed for sale</strong> — popular
                sizes in both wooden and metal frames, ideal for master and
                guest bedrooms.
              </li>
              <li>
          ...
          <section className="section how-to-buy" id="how-to-buy-bed">
            <h2 className="section-title">How to buy — simple, fast, local</h2>
            ...
            <ol className="steps">
              ...
              <li>
                <strong>Get an instant quote:</strong> We’ll send price, photos
                and delivery cost. Use high-intent keywords like{" "}
              ...
              <li>
                <strong>Inspect &amp; confirm:</strong> Prefer to see in person?
                Visit our Sharjah store. If not, we can send additional photos
                and a short video.
              </li>
              <li>
                <strong>Delivery &amp; installation:</strong> Our partner movers
                pick up and deliver safely — ask about same-day delivery for
                nearby emirates.
              </li>
              <li>
                <strong>Warranty &amp; returns:</strong> We’ll confirm warranty
          ...
          <section className="section warranty" id="warranty-cleaning">
            ...
            <p>
              ...
              sanitized and, when necessary, professionally cleaned or replaced.
            </p>
            <p>
              We provide transparent condition notes and offer limited warranty
              options on select items — another reason customers prefer to{" "}
              <strong>buy used beds for sale</strong> from Rukun Al Arooba.
            </p>
          </section>
        </article>
        <ServiceAside />
      ...
      <CTA
        ...
        desc={
          <>
            <p>
              Message us on WhatsApp now for instant photos, price and delivery
              — we reply within 5–10 minutes.
            </p>
            <p>
              If the bed is in stock we can often deliver the same day — ask now
