  ...
  return (
    <main className="overflow-hidden">
      <section className="grid-wrapper w-full flex items-center justify-center flex-col py-16 md:px-0 px-3">
        ...
        <div className="max-w-3xl mx-auto text-center text mt-5">
          <p>
            ...
            trusted choice for thousands of customers across the UAE for over 20
            years.
          </p>
        </div>
        ...
        <p className="mt-5 border-l-2 border-gray-600 pl-3 italic text-sm text max-w-3xl mx-auto">
          We are trusted buyers and sellers of used furniture serving all areas
          of Ajman with professional delivery, quality guarantees, and the best
          prices in the Ajman used furniture market.
        </p>
      </section>
          ...
          <div className="mt-10 grid md:grid-cols-11 min-h-96 grid-cols-1 gap-7">
            <div className="col-span-4  md:text-right">
              <div className="border-b-2 border-[#c07d53] pb-5">
                ...
                <p className="text mt-2  ">
                  Our constantly updated inventory includes everything needed to
                  furnish homes and offices throughout Ajman.
                </p>
                <p className="text mt-2  ">
                  ...
                  Arooba is your trusted partner for high-quality used furniture
                  in Ajman.
                </p>
                <p className="text mt-2  ">
                  Our used office furniture Ajman collection features executive
                  desks, ergonomic chairs, filing systems, and conference tables
                  from renowned brands, all refurbished to professional
                  standards.
                </p>
              </div>
            </div>
            ...
            <div className="col-span-4">
              <div className="border-b-2 border-[#c07d53] pb-5">
                ...
                <p className="text mt-2  ">
                  We accept cash, online bank transfers, and bank checks, making
                  large purchases convenient and secure. This flexibility is
                  especially important for businesses and families making
                  significant furniture investments.
                </p>
                <p className="text mt-2  ">
                  Our partnership with Abu Muhammad Movers solves another major
                  industry problem. we provide complete door-to-door service
                  throughout Ajman.
                </p>
                <p className="text mt-2  ">
                  Installation services are available for complex items, and our
                  competitive delivery rates to areas like Al Nuaimiya, Al
                  Rashidiya, and Emirates City make quality furniture accessible
                  to everyone.
                </p>
              </div>
            </div>
      ...
      <section className=" mt-36 md:w-11/12 w-full mx-auto md:px-0 px-3 grid md:grid-cols-2  items-center">
        <div className="  md:ml-16">
          ...
          <p className="text mt-5">
            We serve all Ajman areas, including Al Jurf, Al Hamidiyah, Al Rawda,
            and Ajman Downtown, with same-day or next-day collection available.
            Payment is immediate upon pickup - no waiting for checks to clear or
            buyers to appear.
          </p>
      ...
      <section className="md:px-0 px-3 mt-36 max-w-4xl mx-auto border-b-4 pb-5">
        ...
        <p className="mt-3 text">
          Worse, you&apos;re exposed to strangers visiting your home without any
          security guarantees.
        </p>
        <p className="mt-3 text">
          Working with Rukun Al Arooba eliminates these concerns. We provide
          immediate cash payment at agreed prices, professional removal services
          that won&apos;t damage your property, and complete transactions in
          hours rather than weeks.
        </p>
        <p className="mt-3 text">
          For those relocating or downsizing quickly, our bulk purchase options
          for entire room or home contents provide maximum convenience with
          minimal effort.
        </p>
      </section>
      <section className="md:px-0 px-3 mt-36 max-w-4xl mx-auto border-b-4 pb-5">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 mt-36">
        <header className="mb-8">
          ...
          <p className="mt-2 text-gray-600 max-w-3xl">
            We buy high-quality used furniture and household items across Ajman.
            Fast quotes, fair prices, and professional pickup — perfect if
            you’re clearing space, upgrading, or moving.
          </p>
        </header>
          ...
          <div className="lg:col-span-9 space-y-8">
            ...
            >
              ...
              <p className="mt-3 text-gray-700 leading-relaxed">
                ...
                each furniture category so you can quickly see how we can help.
              </p>
            </section>
            ...
            >
              ...
              <p className="mt-3 text-gray-700 leading-relaxed">
                These include wardrobe, mirrors, bed, bookcase, nightstand, coat
                racks, chairs or sofas, and much more. If you are trying to find
                a complete bedroom set, and Used Furniture Buyers in Ajman. You
                will be able to contact us, and we have many things for you to
                choose from to achieve the most effective look for your bedroom.
              </p>
            </section>
            ...
            >
              ...
              <p className="mt-3 text-gray-700 leading-relaxed">
                ...
                that usually starts with the wardrobe. If you’re selling a used
                wardrobe in Ajman, we offer fast, transparent quotes and
                convenient pickup. We evaluate conditions honestly and pay fair
                market prices so you can clear space without the stress.
              </p>
            </section>
            ...
            >
              ...
              <p className="mt-3 text-gray-700 leading-relaxed">
                Sofas are a central piece in many Arab homes and they deserve a
                proper replacement when the time comes. We buy used sofas and
                beds across Ajman — from single-seaters to full living-room sets
                — offering competitive, reasonable prices and pickup that fits
                your schedule.
              </p>
            </section>
            ...
            >
              ...
              <p className="mt-3 text-gray-700 leading-relaxed">
                Dining tables are one of the more expensive furniture items, and
                many people sell them when upgrading. Sellers in Ajman choose us
                because we give clear, fair offers and handle collection
                professionally, making the whole process simple and worry-free.
              </p>
            </section>
            ...
            >
              ...
              <p className="mt-3 text-gray-700 leading-relaxed">
                ...
                condition and market value. While there are many used-furniture
                shops, our reliable inspection process and transparent offers
                make us a preferred choice.
              </p>
            </section>
            ...
            >
              ...
              <p className="mt-3 text-gray-700 leading-relaxed">
                ...
                high-quality items from across Ajman, ensure careful cleaning or
                refurbishment when needed, and aim to deliver a smooth,
            ...
            >
              ...
              <p className="mt-3 text-gray-700 leading-relaxed">
                We purchase used washing machines in Ajman and send technicians
                to inspect the unit’s specifications and performance onsite.
                After a short evaluation we offer a fair price that reflects the
                machine’s condition and functionality — reasonable and
                customer-friendly.
              </p>
            </section>
      ...
      >
        ...
        <div className="grid md:grid-cols-2 grid-cols-1 items-center gap-16 mt-20 md:ml-20">
          <div id="register-company">
            ...
            <p className="mt-3 text">
              Since 2004, we&apos;ve built our reputation on trust, quality, and
              exceptional service. While we officially registered our business
              in 2018, our two decades of experience in the UAE&apos;s used
              furniture trade gives us unmatched expertise in valuation,
              refurbishment, and customer satisfaction.
            </p>
            <p className="text">
              Our physical showroom on Al Estiqlal Street in Sharjah isn&apos;t
              just a warehouse - it&apos;s a carefully curated space where every
        ...
        <div className="grid md:grid-cols-2 grid-cols-1 items-center gap-16 md:mt-10 mt-16 md:ml-20">
          ...
          <div id="5-min-response-time" className="order-1 md:order-2">
            ...
            <p className="mt-3 text">
              ...
              quality and condition. We&apos;ve solved this problem through our
              comprehensive refurbishment process.
            </p>
            <p className="text">
              When we acquire furniture, our expert team performs detailed
              inspections for structural integrity, functionality, and aesthetic
              appeal. Any necessary repairs are completed using
            ...
            <details className="group  rounded-lg mt-5 bg-white ">
              ...
              <p className="text">
                ...
                level of protection is unheard of in the second-hand market and
                demonstrates our confidence in the quality we deliver.
              </p>
            </details>
          </div>
        </div>
      ...
      <section className="md:px-0 px-3 mt-36 max-w-4xl mx-auto border-b-4 pb-5">
        ...
        <p className="mt-7 text">
          ...
          neighborhoods. We&apos;ve developed efficient delivery routes covering
          Al Zahra to Al Jurf, ensuring prompt service regardless of your
          location.
        </p>
        <p className="mt-3 text">
        ...
        <p className="mt-3 text">
          We also specialize in commercial furniture solutions for Ajman&apos;s
          growing business sector, providing offices, restaurants, and retail
          spaces with quality furnishings at fraction of new prices.
        </p>
      </section>
      <FAQs Faqs={ajmanFaqs} />
      <CTA
        ...
        desc={
          <>
            <p>
              If you&apos;re ready to find the perfect pre-owned item or want to
              sell your furniture quickly and easily, Rukun Al Arooba Used
