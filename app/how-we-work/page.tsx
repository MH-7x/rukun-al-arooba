    ...
    <main className="overflow-hidden">
      ...
      <section className="md:px-0 px-3 mt-36 max-w-xl mx-auto ">
        ...
        <div className="flex">
          ...
          <div className="pt-1 pb-8">
            <h3 className="mb-2 text-xl font-bold blue ">2. Free Valuation</h3>
            <p className="text">
      ...
      <div className="mt-16 grid md:grid-cols-2 grid-cols-1 gap-16 md:w-11/12 w-full mx-auto md:px-0 px-3">
        <div>
          <h4 className="text-xl font-medium headline flex items-center gap-x-2">
            <CheckCircle size={25} className="pri" /> 1. Inspection & Valuation
          </h4>
          <p className="text-sm text mt-2 pb-3 border-b-2 border-[#c07d53a5]">
            Send photos via WhatsApp, upload images on this page, or book a free
            in-store / home inspection. We evaluate each item by brand,
            condition, age and market demand to give a transparent, itemized
            quote. Our WhatsApp response time is typically 5–10 minutes when you
            contact us online.
          </p>
        </div>
        <div>
        ...
        <div>
          ...
          <p className="text-sm text mt-2 pb-3 border-b-2 border-[#c07d53a5]">
            ...
            delivery and on-site assembly. <b>Service note</b>: Free pickup may
            be available for specific locations or above a minimum order —
            display your exact terms here.
          </p>
        </div>
        <div>
          <h4 className="text-xl font-medium headline flex items-center gap-x-2">
            <CheckCircle size={25} className="pri" /> 4. Refurbishment & Quality
            Control — “Like-New” Standard
          </h4>
          <p className="text-sm text mt-2">
      ...
      >
        <div>
          <h2 className="headline  md:text-4xl/tight text-3xl/tight font-bold">
            <span className="border-b-4 border-[#ffdb5e]">Service Areas &</span>{" "}
      ...
      <section className="md:px-0 px-3 mt-36 max-w-4xl mx-auto border-b-4 pb-5">
        ...
        <p className="mt-7 text">
          Officially registered (since 2018) with a physical storefront and 20+
      ...
      <section className="md:px-0 px-3 mt-36 max-w-4xl mx-auto border-b-4 pb-5">
        ...
        <p className="mt-7 text">
          ...
          item gets professional cleaning and sanitisation before it reaches the
          showroom or a customer’s home — a safe and eco-friendly choice.
        </p>
      </section>
      <FAQs Faqs={hwwFaqs} />
      <CTA
