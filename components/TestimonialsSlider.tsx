        ...
        {reviews
          ? reviews.map((item) => (
              <SwiperSlide key={item.id}>
                <div className="bg-blue-50 rounded-3xl  p-6 relative text-start">
                  {/* Stars */}
          ...
          : testimonials.map((item) => (
              <SwiperSlide key={item.id}>
                <div className="bg-blue-50 rounded-3xl  md:p-10 p-8 relative text-start">
                  {/* Stars */}
                  <div className="flex justify-start mb-4 gap-1">
                    ...
                    <Verified className="text-white fill-blue-600 w-5 h-5 ml-2" />
                  </div>
