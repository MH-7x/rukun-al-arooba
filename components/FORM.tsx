    ...
    <>
      <form onSubmit={handleSubmit} noValidate>
        ...
        <div className="flex items-start gap-3 mb-4">
          <input id="consent" type="checkbox" defaultChecked className="mt-1" />
      ...
      {success && (
        <div
          ...
          role="status"
        >
          <strong className="block">Thanks {success.name || "there"}!</strong>
          <p className="text-sm">
            We received your request. Reference:{" "}
            <span className="font-mono">{success.id}</span>. We&lsquo;ll reach
            out shortly on WhatsApp.
          </p>
        </div>
      )}
